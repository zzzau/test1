    ...
    <div style="text-align: center; margin: 0 20px">
      ...
      <el-form :model="form" :rules="rules" @validate="onValidate" ref="formRef" style="margin-top: 50px">
        ...
        <el-form-item  prop="code">
          <el-row :gutter="10" style="width: 100%">
            ...
            <el-col :span="7">
              <el-button @click="validateEmail" :disabled="!isEmailValid || coldTime>0" type="success" style="width: 100%">{{ coldTime > 0 ? '请' + coldTime + '秒后重试' : '获取验证码' }}</el-button>
            </el-col>
          </el-row>
        </el-form-item>
      </el-form>
      ...
      <div style="margin-top: 20px">
        ...
        <el-link
            ...
            @click="router.push({ name: 'welcome-login' })"
        >
          立即登录
        </el-link>
      </div>
...
const rules = {
  ...
  email:[
    { required: true, message: '请电子邮箱地址', trigger: 'blur' },
...
const register = () => {
  formRef.value.validate((isValid) => {
    if (isValid) {
      ...
      post('/api/auth/register', params, (message) => {
